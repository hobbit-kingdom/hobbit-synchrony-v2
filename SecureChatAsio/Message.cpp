...
std::string messageTypeToString(MessageType type) {
    switch (type) {
    case MessageType::PUBLIC_KEY_EXCHANGE: return "PUBLIC_KEY_EXCHANGE";
    ...
    try {
        ...
        while (std::getline(ss, line)) {
            if (line.rfind("TYPE:", 0) == 0) {
                ...
                if (type_str == "PUBLIC_KEY_EXCHANGE") type = MessageType::PUBLIC_KEY_EXCHANGE;
                else if (type_str == "CHAT_MESSAGE") type = MessageType::CHAT_MESSAGE;
            }
